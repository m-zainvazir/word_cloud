...
if uploaded_file:
    ...
    st.subheader("Word Count Table (Including Custom Stopwords)")
    ...
    filtered_text = filter_stopwords(text, custom_stopwords)
    st.subheader("Word Count Table (Excluding Custom Stopwords)")
